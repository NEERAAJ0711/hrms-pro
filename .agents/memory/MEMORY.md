...
- [Storage layering](storage-layering.md) — IStorage split into 13 domain interfaces + per-domain repositories; DatabaseStorage is a delegating facade; brace-split gotchas
