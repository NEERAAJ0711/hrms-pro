...
// AuditService — business/service layer for the Audit domain (Task: storage layering).
// Wraps AuditRepository so route handlers depend on a service seam instead of
