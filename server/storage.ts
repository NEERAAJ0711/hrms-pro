...
// IStorage and its per-domain sub-interfaces now live in ./storage-interfaces
// (Task #5 Phase A). Re-exported here so existing
// `import { IStorage } from "./storage"` continues to work unchanged.
export type {
  IStorage,
  IUserStorage,
  ICompanyStorage,
