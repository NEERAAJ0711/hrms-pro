...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='company_contractors_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='company_contractors_contractor_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='contractor_employees_company_contractor_id_company_contractors_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='contractor_employees_employee_id_employees_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_user_id_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_reporting_manager_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_time_office_policy_id_time_office_policies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_wage_grade_id_wage_grades_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_contractor_master_id_contractor_masters_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employees_leave_policy_id_leave_policies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='master_departments_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='master_designations_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='wage_grades_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='master_locations_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='earning_heads_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='deduction_heads_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='statutory_settings_company_id_companies_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='attendance_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_types_company_id_companies_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_requests_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_requests_leave_type_id_leave_types_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_requests_approved_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_policies_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='salary_structures_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='salary_structures_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='payroll_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='payroll_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='settings_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='time_office_policies_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='fnf_settlements_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='fnf_settlements_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='fnf_settlements_approved_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='holidays_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='biometric_devices_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='biometric_punch_logs_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='biometric_punch_logs_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='biometric_device_users_device_id_biometric_devices_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='job_postings_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='job_applications_job_posting_id_job_postings_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='job_applications_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='job_applications_applicant_user_id_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='job_applications_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='job_applications_reviewed_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='candidate_profiles_user_id_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='previous_experiences_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='previous_experiences_candidate_profile_id_candidate_profiles_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='loan_advances_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='loan_advances_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='loan_advances_approved_by_users_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='user_permissions_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='module_access_requests_user_id_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='module_access_requests_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='module_access_requests_decided_by_users_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='profile_update_requests_user_id_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='profile_update_requests_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='profile_update_requests_reviewed_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_adjustments_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_adjustments_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_adjustments_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='contractor_masters_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='cd_accounts_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='cd_transactions_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='cd_transactions_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='daily_billing_logs_company_id_companies_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='expenses_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='expenses_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='expenses_approved_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_adjustments_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_adjustments_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_adjustments_leave_type_id_leave_types_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='leave_adjustments_adjusted_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='comp_off_applications_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='comp_off_applications_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='comp_off_applications_approved_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_templates_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_templates_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_template_kpis_template_id_kra_templates_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_assignments_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_assignments_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_assignments_template_id_kra_templates_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_assignments_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kra_assignment_kpis_assignment_id_kra_assignments_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='automation_jobs_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='automation_jobs_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='automation_logs_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='automation_logs_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='automation_logs_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='portal_sessions_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='portal_sessions_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_registrations_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_registrations_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_registrations_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_registrations_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_kyc_records_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_kyc_records_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_kyc_records_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_kyc_records_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_ecr_returns_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_ecr_returns_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='epfo_ecr_returns_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_registrations_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_registrations_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_registrations_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_registrations_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_monthly_returns_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_monthly_returns_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_monthly_returns_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='challans_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='challans_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='challans_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_calendar_events_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_calendar_events_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='outdoor_entries_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='outdoor_entries_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='outdoor_entries_approved_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_fetched_employees_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='esic_fetched_employees_job_id_automation_jobs_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='ai_conversations_employee_id_employees_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='ai_conversations_company_id_companies_id_fk') THEN
...
DO $$ BEGIN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='ai_follow_up_tasks_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='ai_follow_up_tasks_user_id_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='ai_follow_up_tasks_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='ai_follow_up_tasks_escalated_to_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kyc_submission_status_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='kyc_submission_status_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_employee_setup_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_employee_setup_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_employee_setup_wage_grade_id_wage_grades_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_employee_setup_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_clients_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_clients_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_carry_forward_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_carry_forward_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_client_employees_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_client_employees_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_client_employees_client_id_compliance_clients_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='compliance_client_employees_created_by_users_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='placeholder_backfill_heals_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='placeholder_backfill_heals_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employee_documents_company_id_companies_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employee_documents_employee_id_employees_id_fk') THEN
  ...
  END $$;
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname='employee_documents_created_by_users_id_fk') THEN
